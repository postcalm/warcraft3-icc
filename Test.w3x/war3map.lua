...
function Trig_test_Func002001002()
    return (GetDestructableTypeId(GetLastCreatedDestructable()) == FourCC("YTfc"))
end

function Trig_test_Actions()
    KillDestructable(RandomDestructableInRectBJ(nil, Condition(Trig_test_Func002001002)))
...
function InitTrig_test()
    ...
    TriggerRegisterEnterRectSimple(gg_trg_test, gg_rct________________000)
